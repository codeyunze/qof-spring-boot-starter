package io.github.codeyunze.storage.local;
...
public class LocalQofClient extends AbstractQofClient implements ObjectStorageProvider {

    @Override
    public String mode() {
        return QofConstant.StorageMode.LOCAL;
    }
