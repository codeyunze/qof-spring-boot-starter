...
public class QofCoreConfiguration {
    ...
    public FileController fileController(QofClientFactory qofClientFactory,
                                         io.github.codeyunze.spi.FileMetadataRepository metadataRepository,
                                         org.springframework.beans.factory.ObjectProvider<io.github.codeyunze.spi.FileMetadataQuery> metadataQueryProvider) {
